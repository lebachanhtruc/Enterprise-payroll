...
async function verifyAuth(req, res, next) {
  try {
    ...
    const { data: profile, error: profileError } = await userClient.from("profiles").select("company_id").eq("id", user.id).single();
...
app.post("/api/generate-rule", verifyAuth, async (req, res) => {
  try {
    const body = req.body;
...
app.post("/api/seed-sandbox", verifyAuth, async (req, res) => {
  try {
    const authReq = req;
    ...
    const mockEmployees = [
      // BOH
      { nickname: "Truc Le", tax_name: "Ba Chanh Truc Le", custom_rate: 25, standard_rate: 25, sin: "", address: "", rule: { type: "FIXED_TOTAL", fixedHrs: 40, fixedTip: 700 } },
      { nickname: "JP", tax_name: "Jean-Paul Tremblay", custom_rate: 22, standard_rate: 22, sin: "", address: "", rule: { type: "STANDARD_MAX", maxHrs: 44 } },
      { nickname: "Sophie", tax_name: "Sophie Dinh", custom_rate: 20, standard_rate: 20, sin: "", address: "", rule: { type: "GUARANTEED_MIN_HOURS", guaranteedBaseHrs: 35 } },
      { nickname: "Luc", tax_name: "Lucas Fortin", custom_rate: 19, standard_rate: 19, sin: "", address: "", rule: { type: "STANDARD_MAX", maxHrs: 40 } },
      { nickname: "Minh", tax_name: "Le Minh", custom_rate: 18, standard_rate: 18, sin: "", address: "", rule: { type: "STANDARD_MAX", maxHrs: 40 } },
      { nickname: "Dave", tax_name: "David Cote", custom_rate: 20, standard_rate: 20, sin: "", address: "", rule: { type: "STANDARD_MAX", maxHrs: 40 } },
      { nickname: "Bella", tax_name: "Isabella Gagnon", custom_rate: 18, standard_rate: 18, sin: "", address: "", rule: { type: "STANDARD_MAX", maxHrs: 40 } },
      { nickname: "Thomas", tax_name: "Thomas Bouchard", custom_rate: 18, standard_rate: 18, sin: "", address: "", rule: { type: "STANDARD_MAX", maxHrs: 40 } },
      { nickname: "Khoa", tax_name: "Tran Dang Khoa", custom_rate: 19.5, standard_rate: 19.5, sin: "", address: "", rule: { type: "STANDARD_MAX", maxHrs: 40 } },
      { nickname: "Alex", tax_name: "Alexandre Roy", custom_rate: 22, standard_rate: 22, sin: "", address: "", rule: { type: "STANDARD_MAX", maxHrs: 40 } },
      { nickname: "Marie", tax_name: "Marie Pelletier", custom_rate: 18.5, standard_rate: 18.5, sin: "", address: "", rule: { type: "GUARANTEED_MIN_HOURS", guaranteedBaseHrs: 30 } },
      { nickname: "Hugo", tax_name: "Hugo Lavoie", custom_rate: 18, standard_rate: 18, sin: "", address: "", rule: { type: "STANDARD_MAX", maxHrs: 40 } },
      // FOH
      { nickname: "Chloe", tax_name: "Chloe Dubois", custom_rate: 16.6, standard_rate: 16.6, sin: "", address: "", rule: { type: "CHECK_PLUS_CASH", fixedCheckHrs: 10, fixedCheckTip: 30 } },
      { nickname: "Kevin", tax_name: "Dang Tuan Kiet", custom_rate: 16.6, standard_rate: 16.6, sin: "", address: "", rule: { type: "COST_ALLOCATION_OUT_PERCENT", maxOwnHrs: 20 } },
      { nickname: "Hai", tax_name: "Nguyen Vu Hai", custom_rate: 16.6, standard_rate: 16.6, sin: "", address: "", rule: { type: "COST_ALLOCATION_IN_PERCENT", hrsPercent: 40, tipPercent: 40 } },
      { nickname: "Emma", tax_name: "Emma Roy", custom_rate: 16.6, standard_rate: 16.6, sin: "", address: "", rule: { type: "COST_ALLOCATION_OUT_FLAT", hrsToGive: 15 } },
      { nickname: "Liam", tax_name: "Liam Nguyen", custom_rate: 16.6, standard_rate: 16.6, sin: "", address: "", rule: { type: "COST_ALLOCATION_IN_FLAT" } },
      { nickname: "Olivia", tax_name: "Olivia Martin", custom_rate: 16.6, standard_rate: 16.6, sin: "", address: "", rule: { type: "COST_ALLOCATION_IN_PERCENT", hrsPercent: 30, tipPercent: 30 } },
      { nickname: "Noah", tax_name: "Noah Tremblay", custom_rate: 16.6, standard_rate: 16.6, sin: "", address: "", rule: { type: "COST_ALLOCATION_IN_PERCENT", hrsPercent: 30, tipPercent: 30 } },
      { nickname: "Zoe", tax_name: "Zoe Leblanc", custom_rate: 16.6, standard_rate: 16.6, sin: "", address: "", rule: { type: "COST_ALLOCATION_IN_FLAT" } }
    ];
...
app.post("/api/cron/cleanup-sandbox", async (req, res) => {
  try {
    const authHeader = req.headers.authorization;
