...
import { Settings, Save, Terminal, Users, UserPlus, X, BookOpen, Plus, AlertTriangle, Trash2, Edit, Key } from 'lucide-react';
...
export default function SettingsPanel({ settings, setSettings, setActiveTab }: SettingsPanelProps) {
    ...
    const handleGenerateAiRule = async () => {
        ...
        try {
            ...
            setAiError((err as Error).message || "An error occurred while generating the rule.");
        } finally {
            setAiLoading(false);
        }
    };
                    ...
                    {isCreatingRule ? (
                        <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 mb-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">AI Prompt</label>
                                    <textarea 
                                        rows={3}
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    {aiError && <span className="text-xs font-semibold text-rose-500">{aiError}</span>}
                                </div>
                ...
                <div className="mt-8 pt-8 border-t border-slate-200 flex flex-col items-center">
                    ...
                    >
                        ...
                        Developer: Run System Tests
                            ...
                            <DevTestRunner isOpen={isTestRunnerOpen} onClose={() => setIsTestRunnerOpen(false)} />
            </div>
